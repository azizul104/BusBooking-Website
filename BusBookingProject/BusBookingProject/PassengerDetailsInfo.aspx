                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="2" Text="Dutch Bangla Bank"></asp:ListItem>
                                <asp:ListItem Value="3" Text="">Eastern Bank Ltd</asp:ListItem>
                                <asp:ListItem Value="4" Text="Mutual Trust Bank"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Islami Bank"></asp:ListItem>
                            </asp:DropDownList>
